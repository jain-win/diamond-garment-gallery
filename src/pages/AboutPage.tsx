    ...
    <Layout>
      ...
      <section className="section-container">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h2 className="section-title">A Legacy of Quality and Excellence</h2>
      ...
      <section className="section-container bg-gray-50">
        <div className="flex flex-col items-center mb-12">
          ...
          <h2 className="section-title text-center">The Principles That Guide Our Work</h2>
      ...
      <section className="section-container">
        <div className="flex flex-col items-center mb-12">
          ...
          <h2 className="section-title text-center">The Road to Excellence</h2>
          <div className="w-20 h-1 bg-brand mb-6 mx-auto"></div>
          <p className="section-subtitle text-center mx-auto max-w-3xl">
